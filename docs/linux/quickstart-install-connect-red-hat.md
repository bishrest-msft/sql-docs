...
description:  This quickstart shows how to install SQL Server 2017 or SQL Server 2019 on Red Hat Enterprise Linux (RHEL) andaaa then create and query a database with sqlcmd.
author: VanMSFT 
